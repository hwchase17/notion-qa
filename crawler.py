...
class Crawler:
  ...
  def crawl(self, url):
      Crawler.qa_go_to_page(self, url)
      page = self.page
...
def main():
  url = "https://www.linkedin.com/in/anne-nguyen-541b34144/"
  # url = "https://www.linkedin.com/in/christina-nemez/"
  # url = "https://www.tryexponent.com/"
  _crawler = Crawler()
  # _crawler.go_to_page("google.com")
  browser_content = "\n".join(_crawler.crawl(url=url))
  print(browser_content)
  with open("output_anne.txt", "w") as file:
